...
all:
	...
	ld -m elf_i386 -T linker.ld -nostdlib -o build/mxos.bin build/gdt.o build/boot.o build/ata.o build/vga.o build/window.o build/main.o

clean:
	rm build/main.o build/boot.o build/gdt.o build/mxos.bin build/ata.o build/vga.o build/window.o
	rm -rf build
